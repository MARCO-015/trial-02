...
bot = Client(
    "bot",
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7838532960:AAF_zpM1NnSvBxTMKqJSd-KRRi2IG69H1Ao"),
...
# Constants
OWNER_IDS = [7548265642]  # Replace with the actual owner user IDs

# Global variables
log_channel_id = -1002473805604
authorized_users = []
ALLOWED_CHANNEL_IDS = []
my_name = "𝐊𝐔𝐍𝐀𝐋❤️"
overlay = None 
